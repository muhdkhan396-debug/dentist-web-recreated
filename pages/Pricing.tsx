  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-16 -mt-10">
        <FadeInStagger className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {PRICING_DATA.map((item) => (
            <FadeInItem key={item.service_id} className="h-full">
              <div className="bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden flex flex-col h-full hover:border-secondary transition-colors duration-300">
        ...
        <FadeIn delay={0.4} className="mt-20 max-w-4xl mx-auto bg-white p-10 rounded-xl shadow-sm border border-amber-100">
